    ...
    <div className='how-it-works'>
      ...
      <div className="work-section-top">
        ...
        <p className="work-primary-text">
          Let us guide you through 3 easy steps to find the position of an employee in our company!
        </p>
      </div>
      <div className="work-section-bottom">
          <div className="work-section-info">
            <span className='sp-1'>Login</span>
            <p className='p-1'>Login to your account, see your profile and update/add datasets you want</p>
            <div className="info-boxes-img-container"> 
            </div>
            <span className='sp-2'>Check Now</span>
            <p className='p-2'>click on check now to go to the predictor</p>
            <div className="info-boxes-img-container">
            </div>
